...
class CTextTheme {
  ...
  static TextTheme lightTheme = TextTheme(
    ...
    labelMedium:const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: Color.fromRGBO(0, 0, 0, 0.5),) //black with 0.5 opacity
  );
  ...
  static TextTheme darkTheme = TextTheme(
    ...
    labelMedium:const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: Color.fromRGBO(255, 255, 255, 0.5), ), //white with 0.5 opacity
  );
}